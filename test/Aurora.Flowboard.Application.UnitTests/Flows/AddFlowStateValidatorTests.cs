...
public sealed class AddFlowStateValidatorTests
{
    ...
    {
        AddFlowStateCommand command = new(Guid.Empty, FlowCommandData.StateName, FlowStateCategory.Active, FlowCommandData.StateColor, []);
    ...
    {
        AddFlowStateCommand command = new(Guid.NewGuid(), string.Empty, FlowStateCategory.Active, FlowCommandData.StateColor, []);
    ...
    public void Should_Fail_When_NameExceedsMaxLength()
    {
        ...
        AddFlowStateCommand command = new(Guid.NewGuid(), longName, FlowStateCategory.Active, FlowCommandData.StateColor, []);
