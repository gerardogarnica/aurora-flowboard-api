...
public sealed class AddWorkItemCommentHandlerTests
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IDateTimeProvider _dateTimeProvider;
    private readonly IUserContext _userContext;
    private readonly AddWorkItemCommentHandler _handler;

    public AddWorkItemCommentHandlerTests()
    {
        _dbContext = Substitute.For<IApplicationDbContext>();
        _dateTimeProvider = Substitute.For<IDateTimeProvider>();
        _userContext = Substitute.For<IUserContext>();
        _handler = new AddWorkItemCommentHandler(_dbContext, _dateTimeProvider, _userContext);
    }
    ...
    public async Task Should_ReturnSuccess_When_CommandIsValid()
    {
        ...
        AddWorkItemCommentCommand command = new(workItem.Id, WorkItemCommandData.Content);
