...
public sealed class RemoveWorkItemTagHandlerTests
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IDateTimeProvider _dateTimeProvider;
    private readonly IUserContext _userContext;
    private readonly RemoveWorkItemTagHandler _handler;

    public RemoveWorkItemTagHandlerTests()
    {
        _dbContext = Substitute.For<IApplicationDbContext>();
        _dateTimeProvider = Substitute.For<IDateTimeProvider>();
        _userContext = Substitute.For<IUserContext>();
        _handler = new RemoveWorkItemTagHandler(_dbContext, _dateTimeProvider, _userContext);
    }
    ...
    public async Task Should_ReturnSuccess_When_CommandIsValid()
    {
        ...
        WorkItem workItem = WorkItemCommandData.GetWorkItemWithTag(admin, out Guid tagId);
        ...
        RemoveWorkItemTagCommand command = new(workItem.Id, tagId);
    ...
    [Fact]
    public async Task Should_ReturnDomainError_When_TagNotFound()
    {
        // Arrange
        User admin = WorkItemCommandData.GetAdmin();
        ...
        RemoveWorkItemTagCommand command = new(workItem.Id, Guid.NewGuid());
    ...
    [Fact]
    public async Task Should_NotPersist_When_TagNotFound()
    {
        // Arrange
        User admin = WorkItemCommandData.GetAdmin();
        WorkItem workItem = WorkItemCommandData.GetWorkItem(admin);
