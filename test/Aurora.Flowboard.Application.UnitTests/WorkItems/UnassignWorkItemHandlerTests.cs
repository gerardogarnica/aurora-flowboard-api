...
public sealed class UnassignWorkItemHandlerTests
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IDateTimeProvider _dateTimeProvider;
    private readonly IUserContext _userContext;
    private readonly UnassignWorkItemHandler _handler;

    public UnassignWorkItemHandlerTests()
    {
        _dbContext = Substitute.For<IApplicationDbContext>();
        _dateTimeProvider = Substitute.For<IDateTimeProvider>();
        _userContext = Substitute.For<IUserContext>();
        _handler = new UnassignWorkItemHandler(_dbContext, _dateTimeProvider, _userContext);
    }
    ...
    public async Task Should_ReturnSuccess_When_CommandIsValid()
    {
        ...
        User assignee = WorkItemCommandData.GetAssignee();
        WorkItem workItem = WorkItemCommandData.GetWorkItemWithAssignee(admin, assignee);
        ...
        UnassignWorkItemCommand command = new(workItem.Id);
    ...
    [Fact]
    public async Task Should_ReturnDomainError_When_WorkItemNotAssigned()
    {
        // Arrange
        User admin = WorkItemCommandData.GetAdmin();
    ...
    [Fact]
    public async Task Should_NotPersist_When_WorkItemNotAssigned()
    {
        // Arrange
        User admin = WorkItemCommandData.GetAdmin();
        WorkItem workItem = WorkItemCommandData.GetWorkItem(admin);
